view: visit_facts_dt {
  derived_table: {
    ...
    sql: SELECT
      ...
      WHERE
      date_redeemed > unix_timestamp(date(now() - interval 100 day))  and test = 0 and duplicate = 0 and transaction_present.id_consumer>0 and transaction_present.id_consumer<>56796119
      GROUP BY 1,2,3
       ;;
